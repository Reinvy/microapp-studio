...
/** Pastel chip backgrounds cycled per item (claymorphism palette). */
const CHIP_COLORS = ['#FFD5E5', '#C5E8F7', '#D5B8F5', '#FFF2C5', '#C5F0D5'];
        ...
        <div className="flex flex-wrap gap-2">
          {runs.map((run, idx) => (
            <button
              ...
              style={{ backgroundColor: CHIP_COLORS[idx % CHIP_COLORS.length] }}
            >
